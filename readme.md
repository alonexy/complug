...
```bash
# Kafka 适配
go get github.com/alonexy/complug/contrib/queue/kafka@v1.0.2

# RabbitMQ 适配
go get github.com/alonexy/complug/contrib/queue/rabbitmq@v1.0.2

# Protobuf Codec
go get github.com/alonexy/complug/contrib/queue/protobuf@v1.0.2
```
