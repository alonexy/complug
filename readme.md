...
```bash
# Kafka 适配
go get github.com/alonexy/complug/contrib/queue/kafka@v1.0.6

# RabbitMQ 适配
go get github.com/alonexy/complug/contrib/queue/rabbitmq@v1.0.6

# NATS 适配
go get github.com/alonexy/complug/contrib/queue/nats@v1.0.6

# Protobuf Codec
go get github.com/alonexy/complug/contrib/queue/protobuf@v1.0.6
```
